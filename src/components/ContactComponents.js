                ...
                <div className="col-12 col-md-9">
                    ...
                    <Form model="feedback" onSubmit={(values)=>{this.handleSubmit(values)}}>
                        < Row className="form-group">
                            ...
                            minLength:'length must be greater than 3', maxLength:'length must be less than 15'}}/>                                
                            </Col>
                        ...
                        <Row className="form-group">
                            ...
                            <Control.text model=".telnum" id="telnum" name="telnum"
                                ...
                                <Errors
                            className="text-danger" model=".telnum" show="touched" messages={{required:'Required',
                            minLength:'length must be greater than 3', maxLength:'length must be less than 15',
                            isNumber:'must be a no'}}/>                                
                        ...
                        <Row className="form-group">
                            ...
                            <Control.text model=".email" id="email" name="email"
                                ...
                                <Errors
                            className="text-danger" model=".email" show="touched" messages={{required:'Required',
